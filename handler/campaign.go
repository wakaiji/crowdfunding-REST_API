...
func (h *campaignHandler) GetCampaigns(c *gin.Context) {
	...
	response := helper.APIResponse("List of campaigns", http.StatusOK, "success", campaign.FormatterCampaigns(campaigns))
...
func (h *campaignHandler) GetCampaign(c *gin.Context) {
	...
	response := helper.APIResponse("Campaign detail", http.StatusOK, "success", campaign.FormatterCampaignDetail(campaignDetail))
	c.JSON(http.StatusOK, response)
}
...
func (h *campaignHandler) UploadImage(c *gin.Context) {
	...
	reponse := helper.APIResponse("Success to upload campaign image", http.StatusOK, "success", data)
